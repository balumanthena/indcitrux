...
export default function Home() {
  return (
    <div className="w-full md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
      ...
      {/* 🖥️ Spline Animation for Tablet/Desktop */}
    ...
    <Spline scene="https://prod.spline.design/bNNhKUHPwsBjyiUR/scene.splinecode" />
      ...
      <div className="p-4 mx-auto relative z-10 w-full pt-32 md:pt-56 px-2">
        ...
        <div className="block md:hidden">
          <div className="text-4xl pb-5 px-6 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to bg-neutral-400 bg-opacity-50">
        ...
        {/* ⬇️ Slider always visible */}
        <div className="w-full pt-20 z-10 relative">
          <SliderOne />
        </div>

        {/* ⬇️ Rest of the sections */}
        <WebsiteDesign />
        <GraphicDesign />
        <ShopifyStores />
        <Brands />
