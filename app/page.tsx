...
export default function Home() {
  return (
    <div className="w-full md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
      <Navbar />
      <Spotlight className="flex sm:hidden -top-80 left-80" fill="white" />
  ...
  <div className="p-4 mx-auto relative z-10 w-full pt-32 md:pt-56 px-2">
    ...
    >
      Book a call
        ...
        {/* Spline 3D Scene – visible on desktop only */}
<div className="hidden lg:block relative z-0 w-full h-[700px] overflow-hidden">
